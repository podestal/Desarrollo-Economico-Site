            ...
            <motion.div 
                ...
                className=" bg-black opacity-70 absolute top-0 right-0 w-full z-10 text-white h-screen">
                    <motion.div 
                        ...
                        <h3 className='max-lg:text-6xl text-8xl mb-10'>{bosqueData.title}</h3>
                        <p className='max-lg:text-lg max-lg:leading-[2rem] text-center text-2xl leading-[2.8rem]'>{bosqueData.content}</p>  
                    </motion.div>
            </motion.div>    
        </div>}
        </AnimatePresence>
