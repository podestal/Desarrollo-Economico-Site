...
const Hero = () => {
  ...
  return (
    <div className="w-[1180px] h-[100vh] mx-auto">
        <div className="className='w-full flex justify-center gap-12'">
            <div className='w-full h-[100vh] flex flex-col justify-center items-start relative z-10'>
                <p className='text-[130px] font-palanquin w-full leading-[7.5rem] text-slate-900 font-bold'><span className='drop-shadow-lg bg-gradient-to-r from-blue-600 to-sky-300 bg-clip-text text-transparent'>Islay</span> le dá la bienvenida </p>
