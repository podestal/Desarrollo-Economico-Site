      ...
      <div className="lg:max-w-[660px] xl:max-w-[1180px] 2xl:max-w-[1920px] flex justify-center mx-auto gap-12"> 
        <motion.div 
          ...
          <div className='flex flex-col justify-start max-lg:items-center items-start max-md:gap-2'>
            <h2 className='text-7xl md:text-8xl 2xl:text-[180px] lg:text-[130px] mb-6 drop-shadow-lg bg-gradient-to-r from-blue-900 to-blue-600 bg-clip-text text-transparent font-bold'>ISLAY</h2> 
            <h2 className='text-5xl md:text-6xl lg:text-[110px] 2xl:text-[160px] xl:leading-[7.5rem] 2xl:leading-[11rem]  max-lg:text-center font-palanquin w-full  max-lg:leading-[3.5rem] text-slate-200'><span className=' drop-shadow-lg max-lg:hidden hidden bg-gradient-to-r from-blue-900 to-blue-600 bg-clip-text text-transparent font-bold '>ISLAY</span> TE DA LA BIENVENIDA </h2>
          </div>
